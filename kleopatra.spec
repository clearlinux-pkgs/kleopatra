...
Version  : 24.12.3
Release  : 85
URL      : https://download.kde.org/stable/release-service/24.12.3/src/kleopatra-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kleopatra-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kleopatra-24.12.3.tar.xz.sig
...
%setup -q -n kleopatra-24.12.3
cd %{_builddir}/kleopatra-24.12.3
pushd ..
cp -a kleopatra-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742567395
mkdir -p clr-build
pushd clr-build
