...
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/kleopatra-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/kleopatra-22.12.3.tar.xz.sig
...
%prep
%setup -q -n kleopatra-22.12.3
cd %{_builddir}/kleopatra-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677797050
mkdir -p clr-build
pushd clr-build
