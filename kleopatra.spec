...
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/kleopatra-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/kleopatra-24.12.2.tar.xz.sig
...
%setup -q -n kleopatra-24.12.2
cd %{_builddir}/kleopatra-24.12.2
pushd ..
cp -a kleopatra-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739214989
mkdir -p clr-build
pushd clr-build
...
/usr/share/xdg/kleopatradebugcommandsrc
