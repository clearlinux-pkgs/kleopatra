...
Version  : 19.08.1
Release  : 13
URL      : https://download.kde.org/stable/applications/19.08.1/src/kleopatra-19.08.1.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.1/src/kleopatra-19.08.1.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.1/src/kleopatra-19.08.1.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567734550
mkdir -p clr-build
pushd clr-build
