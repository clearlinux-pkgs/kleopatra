...
Source0  : https://download.kde.org/stable/release-service/22.04.2/src/kleopatra-22.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.2/src/kleopatra-22.04.2.tar.xz.sig
...
%prep
%setup -q -n kleopatra-22.04.2
cd %{_builddir}/kleopatra-22.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654875761
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kleopatra-22.04.2/.krazy.license %{buildroot}/usr/share/package-licenses/kleopatra/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
cp %{_builddir}/kleopatra-22.04.2/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kleopatra/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/kleopatra-22.04.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kleopatra/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kleopatra-22.04.2/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kleopatra/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kleopatra-22.04.2/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kleopatra/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/kleopatra-22.04.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kleopatra/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/kleopatra-22.04.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kleopatra/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/kleopatra-22.04.2/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kleopatra/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kleopatra-22.04.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kleopatra/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kleopatra-22.04.2/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/kleopatra/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/kleopatra-22.04.2/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kleopatra/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/kleopatra-22.04.2/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kleopatra/757b86330df80f81143d5916b3e92b4bcb1b1890
pushd clr-build
%make_install
popd
%find_lang kleopatra
