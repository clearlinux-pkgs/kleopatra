...
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/kleopatra-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/kleopatra-23.08.2.tar.xz.sig
...
%prep
%setup -q -n kleopatra-23.08.2
cd %{_builddir}/kleopatra-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697402333
mkdir -p clr-build
pushd clr-build
